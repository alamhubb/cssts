export default {
  ...
  scripts: {
    ...
    test: "tsdown && tsx tests/test-generated-parser-chain.ts && tsx tests/test-transform-output.ts && tsx tests/test-transform-error-bundle.ts && tsx tests/test-language-server-metadata.ts && tsx tests/test-language-server.ts"
  },
  dependencies: {
