...
} from './css-property-number-types';
...
/** align-content 属性配置类型 */
export type AlignContentConfig = {
  keywords: AlignContentKeyword[];
};

/** align-items 属性配置类型 */
export type AlignItemsConfig = {
  keywords: AlignItemsKeyword[];
};

/** align-self 属性配置类型 */
export type AlignSelfConfig = {
  keywords: AlignSelfKeyword[];
};

/** align-tracks 属性配置类型 */
export type AlignTracksConfig = {
  keywords: AlignTracksKeyword[];
};

/** alignment-baseline 属性配置类型 */
export type AlignmentBaselineConfig = {
...
/** anchor-name 属性配置类型 */
export type AnchorNameConfig = {
  keywords: AnchorNameKeyword[];
};

/** anchor-scope 属性配置类型 */
export type AnchorScopeConfig = {
...
/** animation-composition 属性配置类型 */
export type AnimationCompositionConfig = {
  keywords: AnimationCompositionKeyword[];
};

/** animation-delay 属性配置类型 */
export type AnimationDelayConfig = {
  numberTypes: AnimationDelayPropertyNumberType[];
};

/** animation-direction 属性配置类型 */
export type AnimationDirectionConfig = {
  keywords: AnimationDirectionKeyword[];
};

/** animation-duration 属性配置类型 */
export type AnimationDurationConfig = {
  numberTypes: AnimationDurationPropertyNumberType[];
};

/** animation-fill-mode 属性配置类型 */
export type AnimationFillModeConfig = {
  keywords: AnimationFillModeKeyword[];
};

/** animation-iteration-count 属性配置类型 */
export type AnimationIterationCountConfig = {
  keywords: AnimationIterationCountKeyword[];
  numberTypes: AnimationIterationCountPropertyNumberType[];
};

/** animation-name 属性配置类型 */
export type AnimationNameConfig = {
  keywords: AnimationNameKeyword[];
};

/** animation-play-state 属性配置类型 */
export type AnimationPlayStateConfig = {
  keywords: AnimationPlayStateKeyword[];
};

/** animation-range-end 属性配置类型 */
export type AnimationRangeEndConfig = {
  keywords: AnimationRangeEndKeyword[];
  numberTypes: AnimationRangeEndPropertyNumberType[];
};

/** animation-range-start 属性配置类型 */
export type AnimationRangeStartConfig = {
  keywords: AnimationRangeStartKeyword[];
  numberTypes: AnimationRangeStartPropertyNumberType[];
};

/** animation-timeline 属性配置类型 */
export type AnimationTimelineConfig = {
  keywords: AnimationTimelineKeyword[];
};

/** animation-timing-function 属性配置类型 */
export type AnimationTimingFunctionConfig = {
...
/** backface-visibility 属性配置类型 */
export type BackfaceVisibilityConfig = {
...
/** background-attachment 属性配置类型 */
export type BackgroundAttachmentConfig = {
  keywords: BackgroundAttachmentKeyword[];
};

/** background-blend-mode 属性配置类型 */
export type BackgroundBlendModeConfig = {
  keywords: BackgroundBlendModeKeyword[];
};

/** background-clip 属性配置类型 */
export type BackgroundClipConfig = {
...
/** background-origin 属性配置类型 */
export type BackgroundOriginConfig = {
  keywords: BackgroundOriginKeyword[];
};

/** background-position 属性配置类型 */
export type BackgroundPositionConfig = {
  keywords: BackgroundPositionKeyword[];
  numberTypes: BackgroundPositionPropertyNumberType[];
};

/** background-position-x 属性配置类型 */
export type BackgroundPositionXConfig = {
  keywords: BackgroundPositionXKeyword[];
  numberTypes: BackgroundPositionXPropertyNumberType[];
};

/** background-position-y 属性配置类型 */
export type BackgroundPositionYConfig = {
  keywords: BackgroundPositionYKeyword[];
  numberTypes: BackgroundPositionYPropertyNumberType[];
};

/** background-repeat 属性配置类型 */
export type BackgroundRepeatConfig = {
  keywords: BackgroundRepeatKeyword[];
};

/** background-size 属性配置类型 */
export type BackgroundSizeConfig = {
  keywords: BackgroundSizeKeyword[];
  numberTypes: BackgroundSizePropertyNumberType[];
};

/** baseline-shift 属性配置类型 */
export type BaselineShiftConfig = {
...
/** border-bottom-left-radius 属性配置类型 */
export type BorderBottomLeftRadiusConfig = {
  numberTypes: BorderBottomLeftRadiusPropertyNumberType[];
};

/** border-bottom-right-radius 属性配置类型 */
export type BorderBottomRightRadiusConfig = {
  numberTypes: BorderBottomRightRadiusPropertyNumberType[];
};

/** border-bottom-style 属性配置类型 */
export type BorderBottomStyleConfig = {
  keywords: BorderBottomStyleKeyword[];
};

/** border-bottom-width 属性配置类型 */
export type BorderBottomWidthConfig = {
  keywords: BorderBottomWidthKeyword[];
  numberTypes: BorderBottomWidthPropertyNumberType[];
};

/** border-collapse 属性配置类型 */
export type BorderCollapseConfig = {
...
/** border-end-end-radius 属性配置类型 */
export type BorderEndEndRadiusConfig = {
  numberTypes: BorderEndEndRadiusPropertyNumberType[];
};

/** border-end-start-radius 属性配置类型 */
export type BorderEndStartRadiusConfig = {
  numberTypes: BorderEndStartRadiusPropertyNumberType[];
};

/** border-image-outset 属性配置类型 */
export type BorderImageOutsetConfig = {
  numberTypes: BorderImageOutsetPropertyNumberType[];
};

/** border-image-repeat 属性配置类型 */
export type BorderImageRepeatConfig = {
  keywords: BorderImageRepeatKeyword[];
};

/** border-image-slice 属性配置类型 */
export type BorderImageSliceConfig = {
...
/** border-image-width 属性配置类型 */
export type BorderImageWidthConfig = {
...
/** border-left-style 属性配置类型 */
export type BorderLeftStyleConfig = {
  keywords: BorderLeftStyleKeyword[];
};

/** border-left-width 属性配置类型 */
export type BorderLeftWidthConfig = {
  keywords: BorderLeftWidthKeyword[];
  numberTypes: BorderLeftWidthPropertyNumberType[];
};

/** border-radius 属性配置类型 */
...
/** border-right-style 属性配置类型 */
export type BorderRightStyleConfig = {
  keywords: BorderRightStyleKeyword[];
};

/** border-right-width 属性配置类型 */
export type BorderRightWidthConfig = {
  keywords: BorderRightWidthKeyword[];
  numberTypes: BorderRightWidthPropertyNumberType[];
};

/** border-spacing 属性配置类型 */
export type BorderSpacingConfig = {
  numberTypes: BorderSpacingPropertyNumberType[];
};

/** border-start-end-radius 属性配置类型 */
export type BorderStartEndRadiusConfig = {
  numberTypes: BorderStartEndRadiusPropertyNumberType[];
};

/** border-start-start-radius 属性配置类型 */
export type BorderStartStartRadiusConfig = {
...
/** border-top-left-radius 属性配置类型 */
export type BorderTopLeftRadiusConfig = {
  numberTypes: BorderTopLeftRadiusPropertyNumberType[];
};

/** border-top-right-radius 属性配置类型 */
export type BorderTopRightRadiusConfig = {
  numberTypes: BorderTopRightRadiusPropertyNumberType[];
};

/** border-top-style 属性配置类型 */
export type BorderTopStyleConfig = {
  keywords: BorderTopStyleKeyword[];
};

/** border-top-width 属性配置类型 */
export type BorderTopWidthConfig = {
  keywords: BorderTopWidthKeyword[];
  numberTypes: BorderTopWidthPropertyNumberType[];
};

/** border-width 属性配置类型 */
export type BorderWidthConfig = {
...
/** box-align 属性配置类型 */
export type BoxAlignConfig = {
  keywords: BoxAlignKeyword[];
};

/** box-decoration-break 属性配置类型 */
export type BoxDecorationBreakConfig = {
  keywords: BoxDecorationBreakKeyword[];
};

/** box-direction 属性配置类型 */
export type BoxDirectionConfig = {
  keywords: BoxDirectionKeyword[];
};

/** box-flex 属性配置类型 */
export type BoxFlexConfig = {
  numberTypes: BoxFlexPropertyNumberType[];
};

/** box-flex-group 属性配置类型 */
export type BoxFlexGroupConfig = {
  numberTypes: BoxFlexGroupPropertyNumberType[];
};

/** box-lines 属性配置类型 */
export type BoxLinesConfig = {
  keywords: BoxLinesKeyword[];
};

/** box-ordinal-group 属性配置类型 */
export type BoxOrdinalGroupConfig = {
  numberTypes: BoxOrdinalGroupPropertyNumberType[];
};

/** box-orient 属性配置类型 */
export type BoxOrientConfig = {
  keywords: BoxOrientKeyword[];
};

/** box-pack 属性配置类型 */
export type BoxPackConfig = {
...
/** box-sizing 属性配置类型 */
export type BoxSizingConfig = {
  keywords: BoxSizingKeyword[];
};

/** break-after 属性配置类型 */
export type BreakAfterConfig = {
  keywords: BreakAfterKeyword[];
};

/** break-before 属性配置类型 */
export type BreakBeforeConfig = {
  keywords: BreakBeforeKeyword[];
};

/** break-inside 属性配置类型 */
export type BreakInsideConfig = {
  keywords: BreakInsideKeyword[];
};

/** caption-side 属性配置类型 */
export type CaptionSideConfig = {
...
/** color-interpolation-filters 属性配置类型 */
export type ColorInterpolationFiltersConfig = {
...
/** dominant-baseline 属性配置类型 */
export type DominantBaselineConfig = {
  keywords: DominantBaselineKeyword[];
};

/** empty-cells 属性配置类型 */
export type EmptyCellsConfig = {
  keywords: EmptyCellsKeyword[];
};

/** field-sizing 属性配置类型 */
export type FieldSizingConfig = {
...
/** fill-opacity 属性配置类型 */
export type FillOpacityConfig = {
  numberTypes: FillOpacityPropertyNumberType[];
};

/** fill-rule 属性配置类型 */
export type FillRuleConfig = {
...
/** flex-basis 属性配置类型 */
export type FlexBasisConfig = {
  keywords: FlexBasisKeyword[];
};

/** flex-direction 属性配置类型 */
export type FlexDirectionConfig = {
  keywords: FlexDirectionKeyword[];
};

/** flex-grow 属性配置类型 */
export type FlexGrowConfig = {
  numberTypes: FlexGrowPropertyNumberType[];
};

/** flex-shrink 属性配置类型 */
export type FlexShrinkConfig = {
  numberTypes: FlexShrinkPropertyNumberType[];
};

/** flex-wrap 属性配置类型 */
export type FlexWrapConfig = {
...
/** font-feature-settings 属性配置类型 */
export type FontFeatureSettingsConfig = {
  keywords: FontFeatureSettingsKeyword[];
  numberTypes: FontFeatureSettingsPropertyNumberType[];
};

/** font-kerning 属性配置类型 */
export type FontKerningConfig = {
  keywords: FontKerningKeyword[];
};

/** font-language-override 属性配置类型 */
export type FontLanguageOverrideConfig = {
  keywords: FontLanguageOverrideKeyword[];
};

/** font-optical-sizing 属性配置类型 */
export type FontOpticalSizingConfig = {
  keywords: FontOpticalSizingKeyword[];
};

/** font-palette 属性配置类型 */
export type FontPaletteConfig = {
...
/** font-synthesis 属性配置类型 */
export type FontSynthesisConfig = {
  keywords: FontSynthesisKeyword[];
};

/** font-synthesis-position 属性配置类型 */
export type FontSynthesisPositionConfig = {
  keywords: FontSynthesisPositionKeyword[];
};

/** font-synthesis-small-caps 属性配置类型 */
export type FontSynthesisSmallCapsConfig = {
  keywords: FontSynthesisSmallCapsKeyword[];
};

/** font-synthesis-style 属性配置类型 */
export type FontSynthesisStyleConfig = {
  keywords: FontSynthesisStyleKeyword[];
};

/** font-synthesis-weight 属性配置类型 */
export type FontSynthesisWeightConfig = {
...
/** font-variant-alternates 属性配置类型 */
export type FontVariantAlternatesConfig = {
  keywords: FontVariantAlternatesKeyword[];
};

/** font-variant-caps 属性配置类型 */
export type FontVariantCapsConfig = {
  keywords: FontVariantCapsKeyword[];
};

/** font-variant-east-asian 属性配置类型 */
export type FontVariantEastAsianConfig = {
  keywords: FontVariantEastAsianKeyword[];
};

/** font-variant-emoji 属性配置类型 */
export type FontVariantEmojiConfig = {
  keywords: FontVariantEmojiKeyword[];
};

/** font-variant-ligatures 属性配置类型 */
export type FontVariantLigaturesConfig = {
  keywords: FontVariantLigaturesKeyword[];
};

/** font-variant-numeric 属性配置类型 */
export type FontVariantNumericConfig = {
  keywords: FontVariantNumericKeyword[];
};

/** font-variant-position 属性配置类型 */
export type FontVariantPositionConfig = {
  keywords: FontVariantPositionKeyword[];
};

/** font-variation-settings 属性配置类型 */
export type FontVariationSettingsConfig = {
...
/** forced-color-adjust 属性配置类型 */
export type ForcedColorAdjustConfig = {
  keywords: ForcedColorAdjustKeyword[];
};

/** glyph-orientation-horizontal 属性配置类型 */
export type GlyphOrientationHorizontalConfig = {
  numberTypes: GlyphOrientationHorizontalPropertyNumberType[];
};

/** glyph-orientation-vertical 属性配置类型 */
export type GlyphOrientationVerticalConfig = {
...
/** grid-area 属性配置类型 */
export type GridAreaConfig = {
  keywords: GridAreaKeyword[];
  numberTypes: GridAreaPropertyNumberType[];
};

/** grid-auto-columns 属性配置类型 */
export type GridAutoColumnsConfig = {
  keywords: GridAutoColumnsKeyword[];
  numberTypes: GridAutoColumnsPropertyNumberType[];
};

/** grid-auto-flow 属性配置类型 */
export type GridAutoFlowConfig = {
  keywords: GridAutoFlowKeyword[];
};

/** grid-auto-rows 属性配置类型 */
export type GridAutoRowsConfig = {
...
/** grid-column-end 属性配置类型 */
export type GridColumnEndConfig = {
  keywords: GridColumnEndKeyword[];
  numberTypes: GridColumnEndPropertyNumberType[];
};

/** grid-column-gap 属性配置类型 */
export type GridColumnGapConfig = {
  numberTypes: GridColumnGapPropertyNumberType[];
};

/** grid-column-start 属性配置类型 */
export type GridColumnStartConfig = {
...
/** hyphenate-character 属性配置类型 */
export type HyphenateCharacterConfig = {
  keywords: HyphenateCharacterKeyword[];
};

/** hyphenate-limit-chars 属性配置类型 */
export type HyphenateLimitCharsConfig = {
  keywords: HyphenateLimitCharsKeyword[];
  numberTypes: HyphenateLimitCharsPropertyNumberType[];
};

/** hyphens 属性配置类型 */
export type HyphensConfig = {
  keywords: HyphensKeyword[];
};

/** image-orientation 属性配置类型 */
export type ImageOrientationConfig = {
  keywords: ImageOrientationKeyword[];
  numberTypes: ImageOrientationPropertyNumberType[];
};

/** image-rendering 属性配置类型 */
export type ImageRenderingConfig = {
  keywords: ImageRenderingKeyword[];
};

/** image-resolution 属性配置类型 */
export type ImageResolutionConfig = {
  keywords: ImageResolutionKeyword[];
  numberTypes: ImageResolutionPropertyNumberType[];
};

/** ime-mode 属性配置类型 */
export type ImeModeConfig = {
  keywords: ImeModeKeyword[];
};

/** initial-letter 属性配置类型 */
export type InitialLetterConfig = {
  keywords: InitialLetterKeyword[];
  numberTypes: InitialLetterPropertyNumberType[];
};

/** initial-letter-align 属性配置类型 */
export type InitialLetterAlignConfig = {
  keywords: InitialLetterAlignKeyword[];
};

/** input-security 属性配置类型 */
export type InputSecurityConfig = {
  keywords: InputSecurityKeyword[];
};

/** interpolate-size 属性配置类型 */
export type InterpolateSizeConfig = {
...
/** justify-content 属性配置类型 */
export type JustifyContentConfig = {
  keywords: JustifyContentKeyword[];
};

/** justify-items 属性配置类型 */
export type JustifyItemsConfig = {
  keywords: JustifyItemsKeyword[];
};

/** justify-self 属性配置类型 */
export type JustifySelfConfig = {
  keywords: JustifySelfKeyword[];
};

/** justify-tracks 属性配置类型 */
export type JustifyTracksConfig = {
...
/** line-height-step 属性配置类型 */
export type LineHeightStepConfig = {
...
/** list-style-position 属性配置类型 */
export type ListStylePositionConfig = {
  keywords: ListStylePositionKeyword[];
};

/** list-style-type 属性配置类型 */
export type ListStyleTypeConfig = {
...
/** marker-end 属性配置类型 */
export type MarkerEndConfig = {
  keywords: MarkerEndKeyword[];
};

/** marker-mid 属性配置类型 */
export type MarkerMidConfig = {
  keywords: MarkerMidKeyword[];
};

/** marker-start 属性配置类型 */
export type MarkerStartConfig = {
...
/** mask-border-mode 属性配置类型 */
export type MaskBorderModeConfig = {
  keywords: MaskBorderModeKeyword[];
};

/** mask-border-outset 属性配置类型 */
export type MaskBorderOutsetConfig = {
  numberTypes: MaskBorderOutsetPropertyNumberType[];
};

/** mask-border-repeat 属性配置类型 */
export type MaskBorderRepeatConfig = {
  keywords: MaskBorderRepeatKeyword[];
};

/** mask-border-slice 属性配置类型 */
export type MaskBorderSliceConfig = {
...
/** mask-border-width 属性配置类型 */
export type MaskBorderWidthConfig = {
  keywords: MaskBorderWidthKeyword[];
  numberTypes: MaskBorderWidthPropertyNumberType[];
};

/** mask-clip 属性配置类型 */
export type MaskClipConfig = {
  keywords: MaskClipKeyword[];
};

/** mask-composite 属性配置类型 */
export type MaskCompositeConfig = {
...
/** outline-offset 属性配置类型 */
export type OutlineOffsetConfig = {
  numberTypes: OutlineOffsetPropertyNumberType[];
};

/** outline-style 属性配置类型 */
export type OutlineStyleConfig = {
  keywords: OutlineStyleKeyword[];
};

/** outline-width 属性配置类型 */
export type OutlineWidthConfig = {
...
/** overflow-anchor 属性配置类型 */
export type OverflowAnchorConfig = {
  keywords: OverflowAnchorKeyword[];
};

/** overflow-block 属性配置类型 */
export type OverflowBlockConfig = {
  keywords: OverflowBlockKeyword[];
};

/** overflow-clip-box 属性配置类型 */
export type OverflowClipBoxConfig = {
  keywords: OverflowClipBoxKeyword[];
};

/** overflow-clip-margin 属性配置类型 */
export type OverflowClipMarginConfig = {
  keywords: OverflowClipMarginKeyword[];
  numberTypes: OverflowClipMarginPropertyNumberType[];
};

/** overflow-inline 属性配置类型 */
export type OverflowInlineConfig = {
  keywords: OverflowInlineKeyword[];
};

/** overflow-wrap 属性配置类型 */
export type OverflowWrapConfig = {
  keywords: OverflowWrapKeyword[];
};

/** overflow-x 属性配置类型 */
export type OverflowXConfig = {
  keywords: OverflowXKeyword[];
};

/** overflow-y 属性配置类型 */
export type OverflowYConfig = {
...
/** overscroll-behavior 属性配置类型 */
export type OverscrollBehaviorConfig = {
  keywords: OverscrollBehaviorKeyword[];
};

/** overscroll-behavior-block 属性配置类型 */
export type OverscrollBehaviorBlockConfig = {
  keywords: OverscrollBehaviorBlockKeyword[];
};

/** overscroll-behavior-inline 属性配置类型 */
export type OverscrollBehaviorInlineConfig = {
  keywords: OverscrollBehaviorInlineKeyword[];
};

/** overscroll-behavior-x 属性配置类型 */
export type OverscrollBehaviorXConfig = {
  keywords: OverscrollBehaviorXKeyword[];
};

/** overscroll-behavior-y 属性配置类型 */
export type OverscrollBehaviorYConfig = {
...
/** padding-bottom 属性配置类型 */
export type PaddingBottomConfig = {
  numberTypes: PaddingBottomPropertyNumberType[];
};

/** padding-left 属性配置类型 */
export type PaddingLeftConfig = {
  numberTypes: PaddingLeftPropertyNumberType[];
};

/** padding-right 属性配置类型 */
export type PaddingRightConfig = {
  numberTypes: PaddingRightPropertyNumberType[];
};

/** padding-top 属性配置类型 */
export type PaddingTopConfig = {
...
/** page-break-after 属性配置类型 */
export type PageBreakAfterConfig = {
  keywords: PageBreakAfterKeyword[];
};

/** page-break-before 属性配置类型 */
export type PageBreakBeforeConfig = {
  keywords: PageBreakBeforeKeyword[];
};

/** page-break-inside 属性配置类型 */
export type PageBreakInsideConfig = {
  keywords: PageBreakInsideKeyword[];
};

/** paint-order 属性配置类型 */
export type PaintOrderConfig = {
  keywords: PaintOrderKeyword[];
};

/** pause-after 属性配置类型 */
export type PauseAfterConfig = {
  keywords: PauseAfterKeyword[];
  numberTypes: PauseAfterPropertyNumberType[];
};

/** pause-before 属性配置类型 */
export type PauseBeforeConfig = {
...
/** perspective-origin 属性配置类型 */
export type PerspectiveOriginConfig = {
  keywords: PerspectiveOriginKeyword[];
  numberTypes: PerspectiveOriginPropertyNumberType[];
};

/** pointer-events 属性配置类型 */
export type PointerEventsConfig = {
...
/** position-anchor 属性配置类型 */
export type PositionAnchorConfig = {
  keywords: PositionAnchorKeyword[];
};

/** position-area 属性配置类型 */
export type PositionAreaConfig = {
  keywords: PositionAreaKeyword[];
};

/** position-try-fallbacks 属性配置类型 */
export type PositionTryFallbacksConfig = {
  keywords: PositionTryFallbacksKeyword[];
};

/** position-try-order 属性配置类型 */
export type PositionTryOrderConfig = {
  keywords: PositionTryOrderKeyword[];
};

/** position-visibility 属性配置类型 */
export type PositionVisibilityConfig = {
  keywords: PositionVisibilityKeyword[];
};

/** print-color-adjust 属性配置类型 */
export type PrintColorAdjustConfig = {
...
/** row-gap 属性配置类型 */
export type RowGapConfig = {
  keywords: RowGapKeyword[];
  numberTypes: RowGapPropertyNumberType[];
};

/** ruby-align 属性配置类型 */
export type RubyAlignConfig = {
  keywords: RubyAlignKeyword[];
};

/** ruby-merge 属性配置类型 */
export type RubyMergeConfig = {
  keywords: RubyMergeKeyword[];
};

/** ruby-position 属性配置类型 */
export type RubyPositionConfig = {
...
/** scroll-behavior 属性配置类型 */
export type ScrollBehaviorConfig = {
  keywords: ScrollBehaviorKeyword[];
};

/** scroll-margin 属性配置类型 */
export type ScrollMarginConfig = {
  numberTypes: ScrollMarginPropertyNumberType[];
};

/** scroll-margin-block 属性配置类型 */
export type ScrollMarginBlockConfig = {
  numberTypes: ScrollMarginBlockPropertyNumberType[];
};

/** scroll-margin-block-end 属性配置类型 */
export type ScrollMarginBlockEndConfig = {
  numberTypes: ScrollMarginBlockEndPropertyNumberType[];
};

/** scroll-margin-block-start 属性配置类型 */
export type ScrollMarginBlockStartConfig = {
  numberTypes: ScrollMarginBlockStartPropertyNumberType[];
};

/** scroll-margin-bottom 属性配置类型 */
export type ScrollMarginBottomConfig = {
  numberTypes: ScrollMarginBottomPropertyNumberType[];
};

/** scroll-margin-inline 属性配置类型 */
export type ScrollMarginInlineConfig = {
  numberTypes: ScrollMarginInlinePropertyNumberType[];
};

/** scroll-margin-inline-end 属性配置类型 */
export type ScrollMarginInlineEndConfig = {
  numberTypes: ScrollMarginInlineEndPropertyNumberType[];
};

/** scroll-margin-inline-start 属性配置类型 */
export type ScrollMarginInlineStartConfig = {
  numberTypes: ScrollMarginInlineStartPropertyNumberType[];
};

/** scroll-margin-left 属性配置类型 */
export type ScrollMarginLeftConfig = {
  numberTypes: ScrollMarginLeftPropertyNumberType[];
};

/** scroll-margin-right 属性配置类型 */
export type ScrollMarginRightConfig = {
  numberTypes: ScrollMarginRightPropertyNumberType[];
};

/** scroll-margin-top 属性配置类型 */
export type ScrollMarginTopConfig = {
  numberTypes: ScrollMarginTopPropertyNumberType[];
};

/** scroll-padding 属性配置类型 */
export type ScrollPaddingConfig = {
  keywords: ScrollPaddingKeyword[];
  numberTypes: ScrollPaddingPropertyNumberType[];
};

/** scroll-padding-block 属性配置类型 */
export type ScrollPaddingBlockConfig = {
  keywords: ScrollPaddingBlockKeyword[];
  numberTypes: ScrollPaddingBlockPropertyNumberType[];
};

/** scroll-padding-block-end 属性配置类型 */
export type ScrollPaddingBlockEndConfig = {
  keywords: ScrollPaddingBlockEndKeyword[];
  numberTypes: ScrollPaddingBlockEndPropertyNumberType[];
};

/** scroll-padding-block-start 属性配置类型 */
export type ScrollPaddingBlockStartConfig = {
  keywords: ScrollPaddingBlockStartKeyword[];
  numberTypes: ScrollPaddingBlockStartPropertyNumberType[];
};

/** scroll-padding-bottom 属性配置类型 */
export type ScrollPaddingBottomConfig = {
  keywords: ScrollPaddingBottomKeyword[];
  numberTypes: ScrollPaddingBottomPropertyNumberType[];
};

/** scroll-padding-inline 属性配置类型 */
export type ScrollPaddingInlineConfig = {
  keywords: ScrollPaddingInlineKeyword[];
  numberTypes: ScrollPaddingInlinePropertyNumberType[];
};

/** scroll-padding-inline-end 属性配置类型 */
export type ScrollPaddingInlineEndConfig = {
  keywords: ScrollPaddingInlineEndKeyword[];
  numberTypes: ScrollPaddingInlineEndPropertyNumberType[];
};

/** scroll-padding-inline-start 属性配置类型 */
export type ScrollPaddingInlineStartConfig = {
  keywords: ScrollPaddingInlineStartKeyword[];
  numberTypes: ScrollPaddingInlineStartPropertyNumberType[];
};

/** scroll-padding-left 属性配置类型 */
export type ScrollPaddingLeftConfig = {
  keywords: ScrollPaddingLeftKeyword[];
  numberTypes: ScrollPaddingLeftPropertyNumberType[];
};

/** scroll-padding-right 属性配置类型 */
export type ScrollPaddingRightConfig = {
  keywords: ScrollPaddingRightKeyword[];
  numberTypes: ScrollPaddingRightPropertyNumberType[];
};

/** scroll-padding-top 属性配置类型 */
export type ScrollPaddingTopConfig = {
  keywords: ScrollPaddingTopKeyword[];
  numberTypes: ScrollPaddingTopPropertyNumberType[];
};

/** scroll-snap-align 属性配置类型 */
export type ScrollSnapAlignConfig = {
  keywords: ScrollSnapAlignKeyword[];
};

/** scroll-snap-coordinate 属性配置类型 */
export type ScrollSnapCoordinateConfig = {
  keywords: ScrollSnapCoordinateKeyword[];
  numberTypes: ScrollSnapCoordinatePropertyNumberType[];
};

/** scroll-snap-destination 属性配置类型 */
export type ScrollSnapDestinationConfig = {
  keywords: ScrollSnapDestinationKeyword[];
  numberTypes: ScrollSnapDestinationPropertyNumberType[];
};

/** scroll-snap-points-x 属性配置类型 */
export type ScrollSnapPointsXConfig = {
  keywords: ScrollSnapPointsXKeyword[];
  numberTypes: ScrollSnapPointsXPropertyNumberType[];
};

/** scroll-snap-points-y 属性配置类型 */
export type ScrollSnapPointsYConfig = {
  keywords: ScrollSnapPointsYKeyword[];
  numberTypes: ScrollSnapPointsYPropertyNumberType[];
};

/** scroll-snap-stop 属性配置类型 */
export type ScrollSnapStopConfig = {
  keywords: ScrollSnapStopKeyword[];
};

/** scroll-snap-type 属性配置类型 */
export type ScrollSnapTypeConfig = {
  keywords: ScrollSnapTypeKeyword[];
};

/** scroll-snap-type-x 属性配置类型 */
export type ScrollSnapTypeXConfig = {
  keywords: ScrollSnapTypeXKeyword[];
};

/** scroll-snap-type-y 属性配置类型 */
export type ScrollSnapTypeYConfig = {
  keywords: ScrollSnapTypeYKeyword[];
};

/** scroll-timeline-axis 属性配置类型 */
export type ScrollTimelineAxisConfig = {
  keywords: ScrollTimelineAxisKeyword[];
};

/** scroll-timeline-name 属性配置类型 */
export type ScrollTimelineNameConfig = {
...
/** scrollbar-gutter 属性配置类型 */
export type ScrollbarGutterConfig = {
  keywords: ScrollbarGutterKeyword[];
};

/** scrollbar-width 属性配置类型 */
export type ScrollbarWidthConfig = {
  keywords: ScrollbarWidthKeyword[];
};

/** shape-image-threshold 属性配置类型 */
export type ShapeImageThresholdConfig = {
  numberTypes: ShapeImageThresholdPropertyNumberType[];
};

/** shape-margin 属性配置类型 */
export type ShapeMarginConfig = {
...
/** shape-rendering 属性配置类型 */
export type ShapeRenderingConfig = {
...
/** stroke-dasharray 属性配置类型 */
export type StrokeDasharrayConfig = {
  keywords: StrokeDasharrayKeyword[];
  numberTypes: StrokeDasharrayPropertyNumberType[];
};

/** stroke-dashoffset 属性配置类型 */
export type StrokeDashoffsetConfig = {
  numberTypes: StrokeDashoffsetPropertyNumberType[];
};

/** stroke-linecap 属性配置类型 */
export type StrokeLinecapConfig = {
  keywords: StrokeLinecapKeyword[];
};

/** stroke-linejoin 属性配置类型 */
export type StrokeLinejoinConfig = {
  keywords: StrokeLinejoinKeyword[];
};

/** stroke-miterlimit 属性配置类型 */
export type StrokeMiterlimitConfig = {
  numberTypes: StrokeMiterlimitPropertyNumberType[];
};

/** stroke-width 属性配置类型 */
export type StrokeWidthConfig = {
...
/** text-align-last 属性配置类型 */
export type TextAlignLastConfig = {
  keywords: TextAlignLastKeyword[];
};

/** text-anchor 属性配置类型 */
export type TextAnchorConfig = {
  keywords: TextAnchorKeyword[];
};

/** text-combine-upright 属性配置类型 */
export type TextCombineUprightConfig = {
...
/** text-decoration-line 属性配置类型 */
export type TextDecorationLineConfig = {
  keywords: TextDecorationLineKeyword[];
};

/** text-decoration-skip 属性配置类型 */
export type TextDecorationSkipConfig = {
  keywords: TextDecorationSkipKeyword[];
};

/** text-decoration-skip-ink 属性配置类型 */
export type TextDecorationSkipInkConfig = {
  keywords: TextDecorationSkipInkKeyword[];
};

/** text-decoration-style 属性配置类型 */
export type TextDecorationStyleConfig = {
  keywords: TextDecorationStyleKeyword[];
};

/** text-decoration-thickness 属性配置类型 */
export type TextDecorationThicknessConfig = {
...
/** text-emphasis-position 属性配置类型 */
export type TextEmphasisPositionConfig = {
  keywords: TextEmphasisPositionKeyword[];
};

/** text-emphasis-style 属性配置类型 */
export type TextEmphasisStyleConfig = {
  keywords: TextEmphasisStyleKeyword[];
};

/** text-indent 属性配置类型 */
export type TextIndentConfig = {
  keywords: TextIndentKeyword[];
  numberTypes: TextIndentPropertyNumberType[];
};

/** text-justify 属性配置类型 */
export type TextJustifyConfig = {
  keywords: TextJustifyKeyword[];
};

/** text-orientation 属性配置类型 */
export type TextOrientationConfig = {
  keywords: TextOrientationKeyword[];
};

/** text-overflow 属性配置类型 */
export type TextOverflowConfig = {
  keywords: TextOverflowKeyword[];
};

/** text-rendering 属性配置类型 */
export type TextRenderingConfig = {
...
/** text-size-adjust 属性配置类型 */
export type TextSizeAdjustConfig = {
  keywords: TextSizeAdjustKeyword[];
  numberTypes: TextSizeAdjustPropertyNumberType[];
};

/** text-spacing-trim 属性配置类型 */
export type TextSpacingTrimConfig = {
  keywords: TextSpacingTrimKeyword[];
};

/** text-transform 属性配置类型 */
export type TextTransformConfig = {
  keywords: TextTransformKeyword[];
};

/** text-underline-offset 属性配置类型 */
export type TextUnderlineOffsetConfig = {
  keywords: TextUnderlineOffsetKeyword[];
  numberTypes: TextUnderlineOffsetPropertyNumberType[];
};

/** text-underline-position 属性配置类型 */
export type TextUnderlinePositionConfig = {
  keywords: TextUnderlinePositionKeyword[];
};

/** text-wrap-mode 属性配置类型 */
export type TextWrapModeConfig = {
  keywords: TextWrapModeKeyword[];
};

/** text-wrap-style 属性配置类型 */
export type TextWrapStyleConfig = {
  keywords: TextWrapStyleKeyword[];
};

/** timeline-scope 属性配置类型 */
export type TimelineScopeConfig = {
...
/** transform-box 属性配置类型 */
export type TransformBoxConfig = {
  keywords: TransformBoxKeyword[];
};

/** transform-origin 属性配置类型 */
export type TransformOriginConfig = {
  keywords: TransformOriginKeyword[];
  numberTypes: TransformOriginPropertyNumberType[];
};

/** transform-style 属性配置类型 */
...
/** transition-behavior 属性配置类型 */
export type TransitionBehaviorConfig = {
  keywords: TransitionBehaviorKeyword[];
};

/** transition-delay 属性配置类型 */
export type TransitionDelayConfig = {
  numberTypes: TransitionDelayPropertyNumberType[];
};

/** transition-duration 属性配置类型 */
export type TransitionDurationConfig = {
  numberTypes: TransitionDurationPropertyNumberType[];
};

/** transition-property 属性配置类型 */
export type TransitionPropertyConfig = {
  keywords: TransitionPropertyKeyword[];
};

/** transition-timing-function 属性配置类型 */
export type TransitionTimingFunctionConfig = {
...
/** vector-effect 属性配置类型 */
export type VectorEffectConfig = {
  keywords: VectorEffectKeyword[];
};

/** vertical-align 属性配置类型 */
export type VerticalAlignConfig = {
  keywords: VerticalAlignKeyword[];
  numberTypes: VerticalAlignPropertyNumberType[];
};

/** view-timeline-axis 属性配置类型 */
export type ViewTimelineAxisConfig = {
  keywords: ViewTimelineAxisKeyword[];
};

/** view-timeline-inset 属性配置类型 */
export type ViewTimelineInsetConfig = {
  keywords: ViewTimelineInsetKeyword[];
  numberTypes: ViewTimelineInsetPropertyNumberType[];
};

/** view-timeline-name 属性配置类型 */
export type ViewTimelineNameConfig = {
  keywords: ViewTimelineNameKeyword[];
};

/** view-transition-name 属性配置类型 */
export type ViewTransitionNameConfig = {
...
/** white-space-collapse 属性配置类型 */
export type WhiteSpaceCollapseConfig = {
  keywords: WhiteSpaceCollapseKeyword[];
};

/** white-space-trim 属性配置类型 */
export type WhiteSpaceTrimConfig = {
  keywords: WhiteSpaceTrimKeyword[];
};

/** widows 属性配置类型 */
export type WidowsConfig = {
