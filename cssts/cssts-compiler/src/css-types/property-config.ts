...
import {
  ...
  Z_INDEX_KEYWORDS,
  ZOOM_KEYWORDS,
  type AccentColorKeyword,
  type AlignContentKeyword,
  type AlignItemsKeyword,
  type AlignSelfKeyword,
  type AlignTracksKeyword,
  type AlignmentBaselineKeyword,
  type AllKeyword,
  type AnchorNameKeyword,
  type AnchorScopeKeyword,
  type AnimationKeyword,
  type AnimationCompositionKeyword,
  type AnimationDirectionKeyword,
  type AnimationFillModeKeyword,
  type AnimationIterationCountKeyword,
  type AnimationNameKeyword,
  type AnimationPlayStateKeyword,
  type AnimationRangeEndKeyword,
  type AnimationRangeStartKeyword,
  type AnimationTimelineKeyword,
  type AnimationTimingFunctionKeyword,
  type AppearanceKeyword,
  type AspectRatioKeyword,
  type AzimuthKeyword,
  type BackdropFilterKeyword,
  type BackfaceVisibilityKeyword,
  type BackgroundKeyword,
  type BackgroundAttachmentKeyword,
  type BackgroundBlendModeKeyword,
  type BackgroundClipKeyword,
  type BackgroundColorKeyword,
  type BackgroundImageKeyword,
  type BackgroundOriginKeyword,
  type BackgroundPositionKeyword,
  type BackgroundPositionXKeyword,
  type BackgroundPositionYKeyword,
  type BackgroundRepeatKeyword,
  type BackgroundSizeKeyword,
  type BaselineShiftKeyword,
  type BorderKeyword,
  type BorderBlockKeyword,
  type BorderBlockEndKeyword,
  type BorderBlockStartKeyword,
  type BorderBottomKeyword,
  type BorderBottomStyleKeyword,
  type BorderBottomWidthKeyword,
  type BorderCollapseKeyword,
  type BorderColorKeyword,
  type BorderImageRepeatKeyword,
  type BorderImageSliceKeyword,
  type BorderImageSourceKeyword,
  type BorderImageWidthKeyword,
  type BorderInlineKeyword,
  type BorderInlineEndKeyword,
  type BorderInlineStartKeyword,
  type BorderLeftKeyword,
  type BorderLeftColorKeyword,
  type BorderLeftStyleKeyword,
  type BorderLeftWidthKeyword,
  type BorderRightKeyword,
  type BorderRightColorKeyword,
  type BorderRightStyleKeyword,
  type BorderRightWidthKeyword,
  type BorderStyleKeyword,
  type BorderTopKeyword,
  type BorderTopColorKeyword,
  type BorderTopStyleKeyword,
  type BorderTopWidthKeyword,
  type BorderWidthKeyword,
  type BottomKeyword,
  type BoxAlignKeyword,
  type BoxDecorationBreakKeyword,
  type BoxDirectionKeyword,
  type BoxLinesKeyword,
  type BoxOrientKeyword,
  type BoxPackKeyword,
  type BoxShadowKeyword,
  type BoxSizingKeyword,
  type BreakAfterKeyword,
  type BreakBeforeKeyword,
  type BreakInsideKeyword,
  type CaptionSideKeyword,
  type CaretColorKeyword,
  type CaretShapeKeyword,
  type ClearKeyword,
  type ClipKeyword,
  type ClipPathKeyword,
  type ClipRuleKeyword,
  type ColorKeyword,
  type ColorInterpolationFiltersKeyword,
  type ColorSchemeKeyword,
  type ColumnCountKeyword,
  type ColumnFillKeyword,
  type ColumnGapKeyword,
  type ColumnRuleColorKeyword,
  type ColumnSpanKeyword,
  type ColumnWidthKeyword,
  type ContainKeyword,
  type ContainIntrinsicBlockSizeKeyword,
  type ContainIntrinsicHeightKeyword,
  type ContainIntrinsicInlineSizeKeyword,
  type ContainIntrinsicSizeKeyword,
  type ContainIntrinsicWidthKeyword,
  type ContainerNameKeyword,
  type ContainerTypeKeyword,
  type ContentKeyword,
  type ContentVisibilityKeyword,
  type CounterIncrementKeyword,
  type CounterResetKeyword,
  type CounterSetKeyword,
  type CueAfterKeyword,
  type CueBeforeKeyword,
  type CursorKeyword,
  type DKeyword,
  type DirectionKeyword,
  type DisplayKeyword,
  type DominantBaselineKeyword,
  type EmptyCellsKeyword,
  type FieldSizingKeyword,
  type FillKeyword,
  type FillRuleKeyword,
  type FilterKeyword,
  type FlexKeyword,
  type FlexBasisKeyword,
  type FlexDirectionKeyword,
  type FlexWrapKeyword,
  type FloatKeyword,
  type FontKeyword,
  type FontFamilyKeyword,
  type FontFeatureSettingsKeyword,
  type FontKerningKeyword,
  type FontLanguageOverrideKeyword,
  type FontOpticalSizingKeyword,
  type FontPaletteKeyword,
  type FontSizeKeyword,
  type FontSizeAdjustKeyword,
  type FontSmoothKeyword,
  type FontStretchKeyword,
  type FontStyleKeyword,
  type FontSynthesisKeyword,
  type FontSynthesisPositionKeyword,
  type FontSynthesisSmallCapsKeyword,
  type FontSynthesisStyleKeyword,
  type FontSynthesisWeightKeyword,
  type FontVariantKeyword,
  type FontVariantAlternatesKeyword,
  type FontVariantCapsKeyword,
  type FontVariantEastAsianKeyword,
  type FontVariantEmojiKeyword,
  type FontVariantLigaturesKeyword,
  type FontVariantNumericKeyword,
  type FontVariantPositionKeyword,
  type FontVariationSettingsKeyword,
  type FontWeightKeyword,
  type ForcedColorAdjustKeyword,
  type GridKeyword,
  type GridAreaKeyword,
  type GridAutoColumnsKeyword,
  type GridAutoFlowKeyword,
  type GridAutoRowsKeyword,
  type GridColumnKeyword,
  type GridColumnEndKeyword,
  type GridColumnStartKeyword,
  type GridRowKeyword,
  type GridRowEndKeyword,
  type GridRowStartKeyword,
  type GridTemplateKeyword,
  type GridTemplateAreasKeyword,
  type GridTemplateColumnsKeyword,
  type GridTemplateRowsKeyword,
  type HangingPunctuationKeyword,
  type HeightKeyword,
  type HyphenateCharacterKeyword,
  type HyphenateLimitCharsKeyword,
  type HyphensKeyword,
  type ImageOrientationKeyword,
  type ImageRenderingKeyword,
  type ImageResolutionKeyword,
  type ImeModeKeyword,
  type InitialLetterKeyword,
  type InitialLetterAlignKeyword,
  type InputSecurityKeyword,
  type InterpolateSizeKeyword,
  type IsolationKeyword,
  type JustifyContentKeyword,
  type JustifyItemsKeyword,
  type JustifySelfKeyword,
  type JustifyTracksKeyword,
  type KerningKeyword,
  type LeftKeyword,
  type LetterSpacingKeyword,
  type LineBreakKeyword,
  type LineClampKeyword,
  type LineHeightKeyword,
  type ListStyleImageKeyword,
  type ListStylePositionKeyword,
  type ListStyleTypeKeyword,
  type MarginKeyword,
  type MarginBottomKeyword,
  type MarginLeftKeyword,
  type MarginRightKeyword,
  type MarginTopKeyword,
  type MarginTrimKeyword,
  type MarkerKeyword,
  type MarkerEndKeyword,
  type MarkerMidKeyword,
  type MarkerStartKeyword,
  type MaskKeyword,
  type MaskBorderModeKeyword,
  type MaskBorderRepeatKeyword,
  type MaskBorderSliceKeyword,
  type MaskBorderSourceKeyword,
  type MaskBorderWidthKeyword,
  type MaskClipKeyword,
  type MaskCompositeKeyword,
  type MaskImageKeyword,
  type MaskModeKeyword,
  type MaskOriginKeyword,
  type MaskPositionKeyword,
  type MaskRepeatKeyword,
  type MaskSizeKeyword,
  type MaskTypeKeyword,
  type MasonryAutoFlowKeyword,
  type MathDepthKeyword,
  type MathShiftKeyword,
  type MathStyleKeyword,
  type MaxHeightKeyword,
  type MaxLinesKeyword,
  type MaxWidthKeyword,
  type MinHeightKeyword,
  type MinWidthKeyword,
  type MixBlendModeKeyword,
  type ObjectFitKeyword,
  type ObjectPositionKeyword,
  type OffsetAnchorKeyword,
  type OffsetPathKeyword,
  type OffsetPositionKeyword,
  type OffsetRotateKeyword,
  type OutlineColorKeyword,
  type OutlineStyleKeyword,
  type OutlineWidthKeyword,
  type OverflowKeyword,
  type OverflowAnchorKeyword,
  type OverflowBlockKeyword,
  type OverflowClipBoxKeyword,
  type OverflowClipMarginKeyword,
  type OverflowInlineKeyword,
  type OverflowWrapKeyword,
  type OverflowXKeyword,
  type OverflowYKeyword,
  type OverlayKeyword,
  type OverscrollBehaviorKeyword,
  type OverscrollBehaviorBlockKeyword,
  type OverscrollBehaviorInlineKeyword,
  type OverscrollBehaviorXKeyword,
  type OverscrollBehaviorYKeyword,
  type PageKeyword,
  type PageBreakAfterKeyword,
  type PageBreakBeforeKeyword,
  type PageBreakInsideKeyword,
  type PaintOrderKeyword,
  type PauseAfterKeyword,
  type PauseBeforeKeyword,
  type PerspectiveKeyword,
  type PerspectiveOriginKeyword,
  type PointerEventsKeyword,
  type PositionKeyword,
  type PositionAnchorKeyword,
  type PositionAreaKeyword,
  type PositionTryFallbacksKeyword,
  type PositionTryOrderKeyword,
  type PositionVisibilityKeyword,
  type PrintColorAdjustKeyword,
  type QuotesKeyword,
  type ResizeKeyword,
  type RestAfterKeyword,
  type RestBeforeKeyword,
  type RightKeyword,
  type RotateKeyword,
  type RowGapKeyword,
  type RubyAlignKeyword,
  type RubyMergeKeyword,
  type RubyPositionKeyword,
  type ScaleKeyword,
  type ScrollBehaviorKeyword,
  type ScrollPaddingKeyword,
  type ScrollPaddingBlockKeyword,
  type ScrollPaddingBlockEndKeyword,
  type ScrollPaddingBlockStartKeyword,
  type ScrollPaddingBottomKeyword,
  type ScrollPaddingInlineKeyword,
  type ScrollPaddingInlineEndKeyword,
  type ScrollPaddingInlineStartKeyword,
  type ScrollPaddingLeftKeyword,
  type ScrollPaddingRightKeyword,
  type ScrollPaddingTopKeyword,
  type ScrollSnapAlignKeyword,
  type ScrollSnapCoordinateKeyword,
  type ScrollSnapDestinationKeyword,
  type ScrollSnapPointsXKeyword,
  type ScrollSnapPointsYKeyword,
  type ScrollSnapStopKeyword,
  type ScrollSnapTypeKeyword,
  type ScrollSnapTypeXKeyword,
  type ScrollSnapTypeYKeyword,
  type ScrollTimelineAxisKeyword,
  type ScrollTimelineNameKeyword,
  type ScrollbarColorKeyword,
  type ScrollbarGutterKeyword,
  type ScrollbarWidthKeyword,
  type ShapeOutsideKeyword,
  type ShapeRenderingKeyword,
  type SpeakKeyword,
  type SpeakAsKeyword,
  type StrokeKeyword,
  type StrokeDasharrayKeyword,
  type StrokeLinecapKeyword,
  type StrokeLinejoinKeyword,
  type TableLayoutKeyword,
  type TextAlignKeyword,
  type TextAlignLastKeyword,
  type TextAnchorKeyword,
  type TextCombineUprightKeyword,
  type TextDecorationColorKeyword,
  type TextDecorationLineKeyword,
  type TextDecorationSkipKeyword,
  type TextDecorationSkipInkKeyword,
  type TextDecorationStyleKeyword,
  type TextDecorationThicknessKeyword,
  type TextEmphasisColorKeyword,
  type TextEmphasisPositionKeyword,
  type TextEmphasisStyleKeyword,
  type TextIndentKeyword,
  type TextJustifyKeyword,
  type TextOrientationKeyword,
  type TextOverflowKeyword,
  type TextRenderingKeyword,
  type TextShadowKeyword,
  type TextSizeAdjustKeyword,
  type TextSpacingTrimKeyword,
  type TextTransformKeyword,
  type TextUnderlineOffsetKeyword,
  type TextUnderlinePositionKeyword,
  type TextWrapModeKeyword,
  type TextWrapStyleKeyword,
  type TimelineScopeKeyword,
  type TopKeyword,
  type TouchActionKeyword,
  type TransformKeyword,
  type TransformBoxKeyword,
  type TransformOriginKeyword,
  type TransformStyleKeyword,
  type TransitionKeyword,
  type TransitionBehaviorKeyword,
  type TransitionPropertyKeyword,
  type TransitionTimingFunctionKeyword,
  type TranslateKeyword,
  type UnicodeBidiKeyword,
  type UserSelectKeyword,
  type VectorEffectKeyword,
  type VerticalAlignKeyword,
  type ViewTimelineAxisKeyword,
  type ViewTimelineInsetKeyword,
  type ViewTimelineNameKeyword,
  type ViewTransitionNameKeyword,
  type VisibilityKeyword,
  type VoiceBalanceKeyword,
  type VoiceDurationKeyword,
  type VoiceFamilyKeyword,
  type VoicePitchKeyword,
  type VoiceRangeKeyword,
  type VoiceRateKeyword,
  type VoiceStressKeyword,
  type VoiceVolumeKeyword,
  type WhiteSpaceKeyword,
  type WhiteSpaceCollapseKeyword,
  type WhiteSpaceTrimKeyword,
  type WidthKeyword,
  type WillChangeKeyword,
  type WordBreakKeyword,
  type WordSpacingKeyword,
  type WordWrapKeyword,
  type WritingModeKeyword,
  type ZIndexKeyword,
  type ZoomKeyword,
} from './keywords';
