...
export interface animationPropertyType {
  keywords: typeof Keywords.ANIMATION_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.ANIMATION_NUMBER_TYPES[number][];
}
...
export interface appearancePropertyType {
  keywords: typeof Keywords.APPEARANCE_KEYWORDS[number][];
}
...
export interface azimuthPropertyType {
  keywords: typeof Keywords.AZIMUTH_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.AZIMUTH_NUMBER_TYPES[number][];
}
...
export interface backgroundPropertyType {
  keywords: typeof Keywords.BACKGROUND_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.BACKGROUND_NUMBER_TYPES[number][];
}
...
export interface borderPropertyType {
  keywords: typeof Keywords.BORDER_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.BORDER_NUMBER_TYPES[number][];
}
...
export interface bottomPropertyType {
  keywords: typeof Keywords.BOTTOM_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.BOTTOM_NUMBER_TYPES[number][];
}
...
export interface caretPropertyType {
  keywords: typeof Keywords.CARET_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.CARET_NUMBER_TYPES[number][];
}
...
export interface clearPropertyType {
  keywords: typeof Keywords.CLEAR_KEYWORDS[number][];
}

export interface clipPropertyType {
  keywords: typeof Keywords.CLIP_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.CLIP_NUMBER_TYPES[number][];
}
...
export interface colorPropertyType {
  keywords: typeof Keywords.COLOR_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.COLOR_NUMBER_TYPES[number][];
}
...
export interface contentPropertyType {
  keywords: typeof Keywords.CONTENT_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.CONTENT_NUMBER_TYPES[number][];
}
...
export interface cuePropertyType {
  keywords: typeof Keywords.CUE_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.CUE_NUMBER_TYPES[number][];
}
...
export interface cursorPropertyType {
  keywords: typeof Keywords.CURSOR_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.CURSOR_NUMBER_TYPES[number][];
}

export interface cxPropertyType {
  numberTypes: typeof NumberTypes.CX_NUMBER_TYPES[number][];
}

export interface cyPropertyType {
  numberTypes: typeof NumberTypes.CY_NUMBER_TYPES[number][];
}

export interface dPropertyType {
  keywords: typeof Keywords.D_KEYWORDS[number][];
}

export interface directionPropertyType {
  keywords: typeof Keywords.DIRECTION_KEYWORDS[number][];
}

export interface displayPropertyType {
  keywords: typeof Keywords.DISPLAY_KEYWORDS[number][];
}
...
export interface fillPropertyType {
  keywords: typeof Keywords.FILL_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.FILL_NUMBER_TYPES[number][];
}
...
export interface filterPropertyType {
  keywords: typeof Keywords.FILTER_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.FILTER_NUMBER_TYPES[number][];
}

export interface flexPropertyType {
  keywords: typeof Keywords.FLEX_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.FLEX_NUMBER_TYPES[number][];
}
...
export interface floatPropertyType {
  keywords: typeof Keywords.FLOAT_KEYWORDS[number][];
}

export interface fontPropertyType {
  keywords: typeof Keywords.FONT_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.FONT_NUMBER_TYPES[number][];
}
...
export interface gapPropertyType {
  keywords: typeof Keywords.GAP_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.GAP_NUMBER_TYPES[number][];
}
...
export interface gridPropertyType {
  keywords: typeof Keywords.GRID_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.GRID_NUMBER_TYPES[number][];
}
...
export interface heightPropertyType {
  keywords: typeof Keywords.HEIGHT_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.HEIGHT_NUMBER_TYPES[number][];
}
...
export interface hyphensPropertyType {
  keywords: typeof Keywords.HYPHENS_KEYWORDS[number][];
}
...
export interface insetPropertyType {
  keywords: typeof Keywords.INSET_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.INSET_NUMBER_TYPES[number][];
}
...
export interface isolationPropertyType {
  keywords: typeof Keywords.ISOLATION_KEYWORDS[number][];
}
...
export interface kerningPropertyType {
  keywords: typeof Keywords.KERNING_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.KERNING_NUMBER_TYPES[number][];
}

export interface leftPropertyType {
  keywords: typeof Keywords.LEFT_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.LEFT_NUMBER_TYPES[number][];
}
...
export interface marginPropertyType {
  keywords: typeof Keywords.MARGIN_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.MARGIN_NUMBER_TYPES[number][];
}
...
export interface markerPropertyType {
  keywords: typeof Keywords.MARKER_KEYWORDS[number][];
}
...
export interface maskPropertyType {
  keywords: typeof Keywords.MASK_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.MASK_NUMBER_TYPES[number][];
}
...
export interface offsetPropertyType {
  keywords: typeof Keywords.OFFSET_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.OFFSET_NUMBER_TYPES[number][];
}
...
export interface opacityPropertyType {
  numberTypes: typeof NumberTypes.OPACITY_NUMBER_TYPES[number][];
}

export interface orderPropertyType {
  numberTypes: typeof NumberTypes.ORDER_NUMBER_TYPES[number][];
}

export interface orphansPropertyType {
  numberTypes: typeof NumberTypes.ORPHANS_NUMBER_TYPES[number][];
}

export interface outlinePropertyType {
  keywords: typeof Keywords.OUTLINE_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.OUTLINE_NUMBER_TYPES[number][];
}
...
export interface overflowPropertyType {
  keywords: typeof Keywords.OVERFLOW_KEYWORDS[number][];
}
...
export interface overlayPropertyType {
  keywords: typeof Keywords.OVERLAY_KEYWORDS[number][];
}
...
export interface paddingPropertyType {
  numberTypes: typeof NumberTypes.PADDING_NUMBER_TYPES[number][];
}
...
export interface pagePropertyType {
  keywords: typeof Keywords.PAGE_KEYWORDS[number][];
}
...
export interface pausePropertyType {
  keywords: typeof Keywords.PAUSE_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.PAUSE_NUMBER_TYPES[number][];
}
...
export interface perspectivePropertyType {
  keywords: typeof Keywords.PERSPECTIVE_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.PERSPECTIVE_NUMBER_TYPES[number][];
}
...
export interface positionPropertyType {
  keywords: typeof Keywords.POSITION_KEYWORDS[number][];
}
...
export interface quotesPropertyType {
  keywords: typeof Keywords.QUOTES_KEYWORDS[number][];
}

export interface rPropertyType {
  numberTypes: typeof NumberTypes.R_NUMBER_TYPES[number][];
}

export interface resizePropertyType {
  keywords: typeof Keywords.RESIZE_KEYWORDS[number][];
}

export interface restPropertyType {
  keywords: typeof Keywords.REST_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.REST_NUMBER_TYPES[number][];
}
...
export interface rightPropertyType {
  keywords: typeof Keywords.RIGHT_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.RIGHT_NUMBER_TYPES[number][];
}

export interface rotatePropertyType {
  keywords: typeof Keywords.ROTATE_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.ROTATE_NUMBER_TYPES[number][];
}
...
export interface rxPropertyType {
  numberTypes: typeof NumberTypes.RX_NUMBER_TYPES[number][];
}

export interface ryPropertyType {
  numberTypes: typeof NumberTypes.RY_NUMBER_TYPES[number][];
}

export interface scalePropertyType {
  keywords: typeof Keywords.SCALE_KEYWORDS[number][];
...
export interface speakPropertyType {
  keywords: typeof Keywords.SPEAK_KEYWORDS[number][];
}
...
export interface strokePropertyType {
  keywords: typeof Keywords.STROKE_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.STROKE_NUMBER_TYPES[number][];
}
...
export interface topPropertyType {
  keywords: typeof Keywords.TOP_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.TOP_NUMBER_TYPES[number][];
}
...
export interface transformPropertyType {
  keywords: typeof Keywords.TRANSFORM_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.TRANSFORM_NUMBER_TYPES[number][];
}
...
export interface transitionPropertyType {
  keywords: typeof Keywords.TRANSITION_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.TRANSITION_NUMBER_TYPES[number][];
}
...
export interface translatePropertyType {
  keywords: typeof Keywords.TRANSLATE_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.TRANSLATE_NUMBER_TYPES[number][];
}
...
export interface visibilityPropertyType {
  keywords: typeof Keywords.VISIBILITY_KEYWORDS[number][];
}
...
export interface widowsPropertyType {
  numberTypes: typeof NumberTypes.WIDOWS_NUMBER_TYPES[number][];
}

export interface widthPropertyType {
  keywords: typeof Keywords.WIDTH_KEYWORDS[number][];
  numberTypes: typeof NumberTypes.WIDTH_NUMBER_TYPES[number][];
}
...
export interface xPropertyType {
  numberTypes: typeof NumberTypes.X_NUMBER_TYPES[number][];
}

export interface yPropertyType {
  numberTypes: typeof NumberTypes.Y_NUMBER_TYPES[number][];
}
...
export interface CSSPropertiesType {
  ...
  animation?: animationPropertyType;
  animationComposition?: animationCompositionPropertyType;
  animationDelay?: animationDelayPropertyType;
  animationDirection?: animationDirectionPropertyType;
  animationDuration?: animationDurationPropertyType;
  animationFillMode?: animationFillModePropertyType;
  animationIterationCount?: animationIterationCountPropertyType;
  animationName?: animationNamePropertyType;
  animationPlayState?: animationPlayStatePropertyType;
  animationRange?: animationRangePropertyType;
  animationRangeEnd?: animationRangeEndPropertyType;
  animationRangeStart?: animationRangeStartPropertyType;
  animationTimeline?: animationTimelinePropertyType;
  animationTimingFunction?: animationTimingFunctionPropertyType;
  appearance?: appearancePropertyType;
  aspectRatio?: aspectRatioPropertyType;
  azimuth?: azimuthPropertyType;
  backdropFilter?: backdropFilterPropertyType;
  backfaceVisibility?: backfaceVisibilityPropertyType;
  background?: backgroundPropertyType;
  backgroundAttachment?: backgroundAttachmentPropertyType;
  backgroundBlendMode?: backgroundBlendModePropertyType;
  backgroundClip?: backgroundClipPropertyType;
  backgroundColor?: backgroundColorPropertyType;
  backgroundImage?: backgroundImagePropertyType;
  backgroundOrigin?: backgroundOriginPropertyType;
  backgroundPosition?: backgroundPositionPropertyType;
  backgroundPositionX?: backgroundPositionXPropertyType;
  backgroundPositionY?: backgroundPositionYPropertyType;
  backgroundRepeat?: backgroundRepeatPropertyType;
  backgroundSize?: backgroundSizePropertyType;
  baselineShift?: baselineShiftPropertyType;
  blockSize?: blockSizePropertyType;
  border?: borderPropertyType;
  borderBlock?: borderBlockPropertyType;
  borderBlockColor?: borderBlockColorPropertyType;
  borderBlockEnd?: borderBlockEndPropertyType;
  borderBlockEndColor?: borderBlockEndColorPropertyType;
  borderBlockEndStyle?: borderBlockEndStylePropertyType;
  borderBlockEndWidth?: borderBlockEndWidthPropertyType;
  borderBlockStart?: borderBlockStartPropertyType;
  borderBlockStartColor?: borderBlockStartColorPropertyType;
  borderBlockStartStyle?: borderBlockStartStylePropertyType;
  borderBlockStartWidth?: borderBlockStartWidthPropertyType;
  borderBlockStyle?: borderBlockStylePropertyType;
  borderBlockWidth?: borderBlockWidthPropertyType;
  borderBottom?: borderBottomPropertyType;
  borderBottomColor?: borderBottomColorPropertyType;
  borderBottomLeftRadius?: borderBottomLeftRadiusPropertyType;
  borderBottomRightRadius?: borderBottomRightRadiusPropertyType;
  borderBottomStyle?: borderBottomStylePropertyType;
  borderBottomWidth?: borderBottomWidthPropertyType;
  borderCollapse?: borderCollapsePropertyType;
  borderColor?: borderColorPropertyType;
  borderEndEndRadius?: borderEndEndRadiusPropertyType;
  borderEndStartRadius?: borderEndStartRadiusPropertyType;
  borderImage?: borderImagePropertyType;
  borderImageOutset?: borderImageOutsetPropertyType;
  borderImageRepeat?: borderImageRepeatPropertyType;
  borderImageSlice?: borderImageSlicePropertyType;
  borderImageSource?: borderImageSourcePropertyType;
  borderImageWidth?: borderImageWidthPropertyType;
  borderInline?: borderInlinePropertyType;
  borderInlineColor?: borderInlineColorPropertyType;
  borderInlineEnd?: borderInlineEndPropertyType;
  borderInlineEndColor?: borderInlineEndColorPropertyType;
  borderInlineEndStyle?: borderInlineEndStylePropertyType;
  borderInlineEndWidth?: borderInlineEndWidthPropertyType;
  borderInlineStart?: borderInlineStartPropertyType;
  borderInlineStartColor?: borderInlineStartColorPropertyType;
  borderInlineStartStyle?: borderInlineStartStylePropertyType;
  borderInlineStartWidth?: borderInlineStartWidthPropertyType;
  borderInlineStyle?: borderInlineStylePropertyType;
  borderInlineWidth?: borderInlineWidthPropertyType;
  borderLeft?: borderLeftPropertyType;
  borderLeftColor?: borderLeftColorPropertyType;
  borderLeftStyle?: borderLeftStylePropertyType;
  borderLeftWidth?: borderLeftWidthPropertyType;
  borderRadius?: borderRadiusPropertyType;
  borderRight?: borderRightPropertyType;
  borderRightColor?: borderRightColorPropertyType;
  borderRightStyle?: borderRightStylePropertyType;
  borderRightWidth?: borderRightWidthPropertyType;
  borderSpacing?: borderSpacingPropertyType;
  borderStartEndRadius?: borderStartEndRadiusPropertyType;
  borderStartStartRadius?: borderStartStartRadiusPropertyType;
  borderStyle?: borderStylePropertyType;
  borderTop?: borderTopPropertyType;
  borderTopColor?: borderTopColorPropertyType;
  borderTopLeftRadius?: borderTopLeftRadiusPropertyType;
  borderTopRightRadius?: borderTopRightRadiusPropertyType;
  borderTopStyle?: borderTopStylePropertyType;
  borderTopWidth?: borderTopWidthPropertyType;
  borderWidth?: borderWidthPropertyType;
  bottom?: bottomPropertyType;
  boxAlign?: boxAlignPropertyType;
  boxDecorationBreak?: boxDecorationBreakPropertyType;
  boxDirection?: boxDirectionPropertyType;
  boxFlex?: boxFlexPropertyType;
  boxFlexGroup?: boxFlexGroupPropertyType;
  boxLines?: boxLinesPropertyType;
  boxOrdinalGroup?: boxOrdinalGroupPropertyType;
  boxOrient?: boxOrientPropertyType;
  boxPack?: boxPackPropertyType;
  boxShadow?: boxShadowPropertyType;
  boxSizing?: boxSizingPropertyType;
  breakAfter?: breakAfterPropertyType;
  breakBefore?: breakBeforePropertyType;
  breakInside?: breakInsidePropertyType;
  captionSide?: captionSidePropertyType;
  caret?: caretPropertyType;
  caretColor?: caretColorPropertyType;
  caretShape?: caretShapePropertyType;
  clear?: clearPropertyType;
  clip?: clipPropertyType;
  clipPath?: clipPathPropertyType;
  clipRule?: clipRulePropertyType;
  color?: colorPropertyType;
  colorInterpolationFilters?: colorInterpolationFiltersPropertyType;
  colorScheme?: colorSchemePropertyType;
  columnCount?: columnCountPropertyType;
  columnFill?: columnFillPropertyType;
  columnGap?: columnGapPropertyType;
  columnRule?: columnRulePropertyType;
  ...
  counterReset?: counterResetPropertyType;
  counterSet?: counterSetPropertyType;
  cue?: cuePropertyType;
  cueAfter?: cueAfterPropertyType;
  cueBefore?: cueBeforePropertyType;
  cursor?: cursorPropertyType;
  cx?: cxPropertyType;
  cy?: cyPropertyType;
  d?: dPropertyType;
  direction?: directionPropertyType;
  display?: displayPropertyType;
  dominantBaseline?: dominantBaselinePropertyType;
  emptyCells?: emptyCellsPropertyType;
  fieldSizing?: fieldSizingPropertyType;
  fill?: fillPropertyType;
  fillOpacity?: fillOpacityPropertyType;
  fillRule?: fillRulePropertyType;
  filter?: filterPropertyType;
  flex?: flexPropertyType;
  flexBasis?: flexBasisPropertyType;
  flexDirection?: flexDirectionPropertyType;
  flexFlow?: flexFlowPropertyType;
  flexGrow?: flexGrowPropertyType;
  flexShrink?: flexShrinkPropertyType;
  flexWrap?: flexWrapPropertyType;
  float?: floatPropertyType;
  font?: fontPropertyType;
  fontFamily?: fontFamilyPropertyType;
  fontFeatureSettings?: fontFeatureSettingsPropertyType;
  fontKerning?: fontKerningPropertyType;
  fontLanguageOverride?: fontLanguageOverridePropertyType;
  fontOpticalSizing?: fontOpticalSizingPropertyType;
  fontPalette?: fontPalettePropertyType;
  fontSize?: fontSizePropertyType;
  fontSizeAdjust?: fontSizeAdjustPropertyType;
  fontSmooth?: fontSmoothPropertyType;
  fontStretch?: fontStretchPropertyType;
  fontStyle?: fontStylePropertyType;
  fontSynthesis?: fontSynthesisPropertyType;
  fontSynthesisPosition?: fontSynthesisPositionPropertyType;
  fontSynthesisSmallCaps?: fontSynthesisSmallCapsPropertyType;
  fontSynthesisStyle?: fontSynthesisStylePropertyType;
  fontSynthesisWeight?: fontSynthesisWeightPropertyType;
  fontVariant?: fontVariantPropertyType;
  fontVariantAlternates?: fontVariantAlternatesPropertyType;
  fontVariantCaps?: fontVariantCapsPropertyType;
  fontVariantEastAsian?: fontVariantEastAsianPropertyType;
  fontVariantEmoji?: fontVariantEmojiPropertyType;
  fontVariantLigatures?: fontVariantLigaturesPropertyType;
  fontVariantNumeric?: fontVariantNumericPropertyType;
  fontVariantPosition?: fontVariantPositionPropertyType;
  fontVariationSettings?: fontVariationSettingsPropertyType;
  fontWeight?: fontWeightPropertyType;
  forcedColorAdjust?: forcedColorAdjustPropertyType;
  gap?: gapPropertyType;
  glyphOrientationHorizontal?: glyphOrientationHorizontalPropertyType;
  glyphOrientationVertical?: glyphOrientationVerticalPropertyType;
  grid?: gridPropertyType;
  gridArea?: gridAreaPropertyType;
  gridAutoColumns?: gridAutoColumnsPropertyType;
  gridAutoFlow?: gridAutoFlowPropertyType;
  gridAutoRows?: gridAutoRowsPropertyType;
  gridColumn?: gridColumnPropertyType;
  gridColumnEnd?: gridColumnEndPropertyType;
  gridColumnGap?: gridColumnGapPropertyType;
  gridColumnStart?: gridColumnStartPropertyType;
  gridGap?: gridGapPropertyType;
  gridRow?: gridRowPropertyType;
  gridRowEnd?: gridRowEndPropertyType;
  gridRowGap?: gridRowGapPropertyType;
  gridRowStart?: gridRowStartPropertyType;
  gridTemplate?: gridTemplatePropertyType;
  gridTemplateAreas?: gridTemplateAreasPropertyType;
  gridTemplateColumns?: gridTemplateColumnsPropertyType;
  gridTemplateRows?: gridTemplateRowsPropertyType;
  hangingPunctuation?: hangingPunctuationPropertyType;
  height?: heightPropertyType;
  hyphenateCharacter?: hyphenateCharacterPropertyType;
  hyphenateLimitChars?: hyphenateLimitCharsPropertyType;
  hyphens?: hyphensPropertyType;
  imageOrientation?: imageOrientationPropertyType;
  imageRendering?: imageRenderingPropertyType;
  imageResolution?: imageResolutionPropertyType;
  imeMode?: imeModePropertyType;
  initialLetter?: initialLetterPropertyType;
  initialLetterAlign?: initialLetterAlignPropertyType;
  inlineSize?: inlineSizePropertyType;
  inputSecurity?: inputSecurityPropertyType;
  inset?: insetPropertyType;
  insetBlock?: insetBlockPropertyType;
  insetBlockEnd?: insetBlockEndPropertyType;
  insetBlockStart?: insetBlockStartPropertyType;
  insetInline?: insetInlinePropertyType;
  insetInlineEnd?: insetInlineEndPropertyType;
  insetInlineStart?: insetInlineStartPropertyType;
  interpolateSize?: interpolateSizePropertyType;
  isolation?: isolationPropertyType;
  justifyContent?: justifyContentPropertyType;
  justifyItems?: justifyItemsPropertyType;
  justifySelf?: justifySelfPropertyType;
  justifyTracks?: justifyTracksPropertyType;
  kerning?: kerningPropertyType;
  left?: leftPropertyType;
  letterSpacing?: letterSpacingPropertyType;
  lineBreak?: lineBreakPropertyType;
  lineClamp?: lineClampPropertyType;
  lineHeight?: lineHeightPropertyType;
  lineHeightStep?: lineHeightStepPropertyType;
  listStyle?: listStylePropertyType;
  listStyleImage?: listStyleImagePropertyType;
  listStylePosition?: listStylePositionPropertyType;
  listStyleType?: listStyleTypePropertyType;
  margin?: marginPropertyType;
  marginBlock?: marginBlockPropertyType;
  marginBlockEnd?: marginBlockEndPropertyType;
  marginBlockStart?: marginBlockStartPropertyType;
  marginBottom?: marginBottomPropertyType;
  marginInline?: marginInlinePropertyType;
  marginInlineEnd?: marginInlineEndPropertyType;
  marginInlineStart?: marginInlineStartPropertyType;
  marginLeft?: marginLeftPropertyType;
  marginRight?: marginRightPropertyType;
  marginTop?: marginTopPropertyType;
  marginTrim?: marginTrimPropertyType;
  marker?: markerPropertyType;
  markerEnd?: markerEndPropertyType;
  markerMid?: markerMidPropertyType;
  markerStart?: markerStartPropertyType;
  mask?: maskPropertyType;
  maskBorder?: maskBorderPropertyType;
  maskBorderMode?: maskBorderModePropertyType;
  maskBorderOutset?: maskBorderOutsetPropertyType;
  maskBorderRepeat?: maskBorderRepeatPropertyType;
  maskBorderSlice?: maskBorderSlicePropertyType;
  maskBorderSource?: maskBorderSourcePropertyType;
  maskBorderWidth?: maskBorderWidthPropertyType;
  maskClip?: maskClipPropertyType;
  maskComposite?: maskCompositePropertyType;
  maskImage?: maskImagePropertyType;
  maskMode?: maskModePropertyType;
  maskOrigin?: maskOriginPropertyType;
  maskPosition?: maskPositionPropertyType;
  maskRepeat?: maskRepeatPropertyType;
  maskSize?: maskSizePropertyType;
  maskType?: maskTypePropertyType;
  masonryAutoFlow?: masonryAutoFlowPropertyType;
  mathDepth?: mathDepthPropertyType;
  mathShift?: mathShiftPropertyType;
  mathStyle?: mathStylePropertyType;
  maxBlockSize?: maxBlockSizePropertyType;
  maxHeight?: maxHeightPropertyType;
  maxInlineSize?: maxInlineSizePropertyType;
  maxLines?: maxLinesPropertyType;
  maxWidth?: maxWidthPropertyType;
  minBlockSize?: minBlockSizePropertyType;
  minHeight?: minHeightPropertyType;
  minInlineSize?: minInlineSizePropertyType;
  minWidth?: minWidthPropertyType;
  mixBlendMode?: mixBlendModePropertyType;
  objectFit?: objectFitPropertyType;
  objectPosition?: objectPositionPropertyType;
  offset?: offsetPropertyType;
  offsetAnchor?: offsetAnchorPropertyType;
  offsetDistance?: offsetDistancePropertyType;
  offsetPath?: offsetPathPropertyType;
  offsetPosition?: offsetPositionPropertyType;
  offsetRotate?: offsetRotatePropertyType;
  opacity?: opacityPropertyType;
  order?: orderPropertyType;
  orphans?: orphansPropertyType;
  outline?: outlinePropertyType;
  outlineColor?: outlineColorPropertyType;
  outlineOffset?: outlineOffsetPropertyType;
  outlineStyle?: outlineStylePropertyType;
  outlineWidth?: outlineWidthPropertyType;
  overflow?: overflowPropertyType;
  overflowAnchor?: overflowAnchorPropertyType;
  overflowBlock?: overflowBlockPropertyType;
  overflowClipBox?: overflowClipBoxPropertyType;
  overflowClipMargin?: overflowClipMarginPropertyType;
  overflowInline?: overflowInlinePropertyType;
  overflowWrap?: overflowWrapPropertyType;
  overflowX?: overflowXPropertyType;
  overflowY?: overflowYPropertyType;
  overlay?: overlayPropertyType;
  overscrollBehavior?: overscrollBehaviorPropertyType;
  overscrollBehaviorBlock?: overscrollBehaviorBlockPropertyType;
  overscrollBehaviorInline?: overscrollBehaviorInlinePropertyType;
  overscrollBehaviorX?: overscrollBehaviorXPropertyType;
  overscrollBehaviorY?: overscrollBehaviorYPropertyType;
  padding?: paddingPropertyType;
  paddingBlock?: paddingBlockPropertyType;
  paddingBlockEnd?: paddingBlockEndPropertyType;
  paddingBlockStart?: paddingBlockStartPropertyType;
  paddingBottom?: paddingBottomPropertyType;
  paddingInline?: paddingInlinePropertyType;
  paddingInlineEnd?: paddingInlineEndPropertyType;
  paddingInlineStart?: paddingInlineStartPropertyType;
  paddingLeft?: paddingLeftPropertyType;
  paddingRight?: paddingRightPropertyType;
  paddingTop?: paddingTopPropertyType;
  page?: pagePropertyType;
  pageBreakAfter?: pageBreakAfterPropertyType;
  pageBreakBefore?: pageBreakBeforePropertyType;
  pageBreakInside?: pageBreakInsidePropertyType;
  paintOrder?: paintOrderPropertyType;
  pause?: pausePropertyType;
  pauseAfter?: pauseAfterPropertyType;
  pauseBefore?: pauseBeforePropertyType;
  perspective?: perspectivePropertyType;
  perspectiveOrigin?: perspectiveOriginPropertyType;
  placeContent?: placeContentPropertyType;
  placeItems?: placeItemsPropertyType;
  placeSelf?: placeSelfPropertyType;
  pointerEvents?: pointerEventsPropertyType;
  position?: positionPropertyType;
  positionAnchor?: positionAnchorPropertyType;
  positionArea?: positionAreaPropertyType;
  positionTry?: positionTryPropertyType;
  positionTryFallbacks?: positionTryFallbacksPropertyType;
  positionTryOrder?: positionTryOrderPropertyType;
  positionVisibility?: positionVisibilityPropertyType;
  printColorAdjust?: printColorAdjustPropertyType;
  quotes?: quotesPropertyType;
  r?: rPropertyType;
  resize?: resizePropertyType;
  rest?: restPropertyType;
  restAfter?: restAfterPropertyType;
  restBefore?: restBeforePropertyType;
  right?: rightPropertyType;
  rotate?: rotatePropertyType;
  rowGap?: rowGapPropertyType;
  rubyAlign?: rubyAlignPropertyType;
  rubyMerge?: rubyMergePropertyType;
  rubyPosition?: rubyPositionPropertyType;
  rx?: rxPropertyType;
  ry?: ryPropertyType;
  ...
  scrollMarginBlockEnd?: scrollMarginBlockEndPropertyType;
  scrollMarginBlockStart?: scrollMarginBlockStartPropertyType;
  scrollMarginBottom?: scrollMarginBottomPropertyType;
  scrollMarginInline?: scrollMarginInlinePropertyType;
  scrollMarginInlineEnd?: scrollMarginInlineEndPropertyType;
  scrollMarginInlineStart?: scrollMarginInlineStartPropertyType;
  scrollMarginLeft?: scrollMarginLeftPropertyType;
  scrollMarginRight?: scrollMarginRightPropertyType;
  scrollMarginTop?: scrollMarginTopPropertyType;
  scrollPadding?: scrollPaddingPropertyType;
  scrollPaddingBlock?: scrollPaddingBlockPropertyType;
  scrollPaddingBlockEnd?: scrollPaddingBlockEndPropertyType;
  scrollPaddingBlockStart?: scrollPaddingBlockStartPropertyType;
  scrollPaddingBottom?: scrollPaddingBottomPropertyType;
  scrollPaddingInline?: scrollPaddingInlinePropertyType;
  scrollPaddingInlineEnd?: scrollPaddingInlineEndPropertyType;
  scrollPaddingInlineStart?: scrollPaddingInlineStartPropertyType;
  scrollPaddingLeft?: scrollPaddingLeftPropertyType;
  scrollPaddingRight?: scrollPaddingRightPropertyType;
  scrollPaddingTop?: scrollPaddingTopPropertyType;
  scrollSnapAlign?: scrollSnapAlignPropertyType;
  scrollSnapCoordinate?: scrollSnapCoordinatePropertyType;
  scrollSnapDestination?: scrollSnapDestinationPropertyType;
  scrollSnapPointsX?: scrollSnapPointsXPropertyType;
  scrollSnapPointsY?: scrollSnapPointsYPropertyType;
  scrollSnapStop?: scrollSnapStopPropertyType;
  scrollSnapType?: scrollSnapTypePropertyType;
  scrollSnapTypeX?: scrollSnapTypeXPropertyType;
  scrollSnapTypeY?: scrollSnapTypeYPropertyType;
  ...
  shapeRendering?: shapeRenderingPropertyType;
  speak?: speakPropertyType;
  speakAs?: speakAsPropertyType;
  stroke?: strokePropertyType;
  strokeDasharray?: strokeDasharrayPropertyType;
  strokeDashoffset?: strokeDashoffsetPropertyType;
  strokeLinecap?: strokeLinecapPropertyType;
  strokeLinejoin?: strokeLinejoinPropertyType;
  ...
  textCombineUpright?: textCombineUprightPropertyType;
  textDecoration?: textDecorationPropertyType;
  textDecorationColor?: textDecorationColorPropertyType;
  textDecorationLine?: textDecorationLinePropertyType;
  textDecorationSkip?: textDecorationSkipPropertyType;
  textDecorationSkipInk?: textDecorationSkipInkPropertyType;
  textDecorationStyle?: textDecorationStylePropertyType;
  textDecorationThickness?: textDecorationThicknessPropertyType;
  textEmphasis?: textEmphasisPropertyType;
  textEmphasisColor?: textEmphasisColorPropertyType;
  textEmphasisPosition?: textEmphasisPositionPropertyType;
  textEmphasisStyle?: textEmphasisStylePropertyType;
  textIndent?: textIndentPropertyType;
  textJustify?: textJustifyPropertyType;
  textOrientation?: textOrientationPropertyType;
  textOverflow?: textOverflowPropertyType;
  textRendering?: textRenderingPropertyType;
  textShadow?: textShadowPropertyType;
  textSizeAdjust?: textSizeAdjustPropertyType;
  textSpacingTrim?: textSpacingTrimPropertyType;
  textTransform?: textTransformPropertyType;
  textUnderlineOffset?: textUnderlineOffsetPropertyType;
  textUnderlinePosition?: textUnderlinePositionPropertyType;
  textWrap?: textWrapPropertyType;
  textWrapMode?: textWrapModePropertyType;
  textWrapStyle?: textWrapStylePropertyType;
  timelineScope?: timelineScopePropertyType;
  top?: topPropertyType;
  touchAction?: touchActionPropertyType;
  transform?: transformPropertyType;
  transformBox?: transformBoxPropertyType;
  transformOrigin?: transformOriginPropertyType;
  transformStyle?: transformStylePropertyType;
  transition?: transitionPropertyType;
  transitionBehavior?: transitionBehaviorPropertyType;
  transitionDelay?: transitionDelayPropertyType;
  transitionDuration?: transitionDurationPropertyType;
  transitionProperty?: transitionPropertyPropertyType;
  transitionTimingFunction?: transitionTimingFunctionPropertyType;
  translate?: translatePropertyType;
  unicodeBidi?: unicodeBidiPropertyType;
  userSelect?: userSelectPropertyType;
  vectorEffect?: vectorEffectPropertyType;
  verticalAlign?: verticalAlignPropertyType;
  viewTimeline?: viewTimelinePropertyType;
  viewTimelineAxis?: viewTimelineAxisPropertyType;
  viewTimelineInset?: viewTimelineInsetPropertyType;
  viewTimelineName?: viewTimelineNamePropertyType;
  viewTransitionName?: viewTransitionNamePropertyType;
  visibility?: visibilityPropertyType;
  voiceBalance?: voiceBalancePropertyType;
  voiceDuration?: voiceDurationPropertyType;
  voiceFamily?: voiceFamilyPropertyType;
  voicePitch?: voicePitchPropertyType;
  voiceRange?: voiceRangePropertyType;
  voiceRate?: voiceRatePropertyType;
  voiceStress?: voiceStressPropertyType;
  voiceVolume?: voiceVolumePropertyType;
  whiteSpace?: whiteSpacePropertyType;
  whiteSpaceCollapse?: whiteSpaceCollapsePropertyType;
  whiteSpaceTrim?: whiteSpaceTrimPropertyType;
  widows?: widowsPropertyType;
  width?: widthPropertyType;
  willChange?: willChangePropertyType;
  wordBreak?: wordBreakPropertyType;
  wordSpacing?: wordSpacingPropertyType;
  wordWrap?: wordWrapPropertyType;
  writingMode?: writingModePropertyType;
  x?: xPropertyType;
  y?: yPropertyType;
  zIndex?: zIndexPropertyType;
  zoom?: zoomPropertyType;
}
