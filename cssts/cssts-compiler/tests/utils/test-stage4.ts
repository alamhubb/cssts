 ...
 *
 * 用法:
 *   npx bun packages/slime-test/src/utils/test-stage4.ts              # 从头开始测试
 *   npx bun packages/slime-test/src/utils/test-stage4.ts 100          # 从第100个开始
 *   npx bun packages/slime-test/src/utils/test-stage4.ts 100 -s       # 从第100个开始，遇错停止
 */
